...
You can visit the online version on of the project on: 
This is the local version of the project. In order to run it you must create a .env file with the necessary environment variables. The file sample_env_file.txt contains an example of how to write the .env file.
